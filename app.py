...
list_of_company = pd.read_csv('C:/Users/ayush sati/Downloads/Stock_Market_Prediction_ML/company list.csv')
...
model = tf.keras.models.load_model('C:/Users/ayush sati/Downloads/Stock_Market_Prediction_ML/Stock Predictions Model.keras')
